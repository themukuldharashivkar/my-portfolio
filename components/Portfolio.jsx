    ...
    <div id="portfolio" className="w-full bg-zinc-800">
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
          {portfolios.map(({ id, title, imageSrc, url }) => (
            <Link key={id} href={`/portfolio/${url}`}>
              <div className="cursor-pointer group shadow-md bg-zinc-900 shadow-amber-500 overflow-hidden rounded-md">
                <Image
                  src={imageSrc}
                  alt={title}
        ...
        <div className="flex items-center justify-center">
          <Link href="/portfolio">
            <div className="group flex items-center justify-center my-8 border-2 border-white bg-amber-500 text-white px-6 py-3 font-bold uppercase rounded-md tracking-wider cursor-pointer hover:text-black">
              all projects
